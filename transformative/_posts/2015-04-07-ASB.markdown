...
summary        : This design made ASB business better. 
---
...
{% gallery { "dummy" : "dummy"} %}
    ...
    {% picture {{page.assetsfolder}}/asb-N103.jpg alt="" %}
    {% picture {{page.assetsfolder}}/asb-N104.jpg alt="" %}
    {% picture {{page.assetsfolder}}/asb-N107.jpg alt="" %}
    {% picture {{page.assetsfolder}}/asb-N187.jpg alt="" %}
    {% picture {{page.assetsfolder}}/asb-N106.jpg alt="" %}
    {% picture {{page.assetsfolder}}/asb-N116.jpg alt="" %}
    {% picture {{page.assetsfolder}}/asb-N150.jpg alt="" %}
    {% picture {{page.assetsfolder}}/ASBsiteplan.jpg alt="" %}
    {% picture {{page.assetsfolder}}/Level2.jpg alt="" %}
    {% picture {{page.assetsfolder}}/Level3.jpg alt="" %}
    {% picture {{page.assetsfolder}}/Level6.jpg alt="" %}
    {% picture {{page.assetsfolder}}/Section.jpg alt="" %}
{% endgallery %}
...
<h3>Location</h3>
<p >Wynyard Quarter, Auckland, NZ</p>
<h3>Client</h3>
<p >Kiwi Income Property Trust + ASB Bank</p>
<h3>Completed</h3>
<p >August 2013</p>
<h3>Floor Area</h3>
<p >28,000m² GFA</p>
...
{% picture {{page.assetsfolder}}/asb-N60.jpg alt="" class="in-column-img" %}
The connecting lane incorporates public art
{: .caption}
...
[This is a Google tour of ASB North Wharf](http://bit.ly/1i71rpm) 
